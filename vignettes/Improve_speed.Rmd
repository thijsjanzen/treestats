...
Across the board, we find that the castor based calculations are generally 
faster than those in treestats (e.g. gamma, sackin, blum and colless). For all 
the others, treestats is faster.
