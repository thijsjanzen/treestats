...
found3 <- left_join(found2, norm_info, by = join_by(statistic))
found3 <- left_join(found3, found_min2, by = join_by(statistic, number_of_lineages))
found3 <- left_join(found3, found_max2, by = join_by(statistic, number_of_lineages))
```
