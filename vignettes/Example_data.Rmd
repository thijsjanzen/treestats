...
The treestats package can rapidly calculate summary statistics on phylogenetic
trees, and in this vignette, we demonstrate this on empirical trees. We will
make use of family-level pruned trees stemming from the clootl supertree of
birds. These were created for the original publication accompanying the
treestats paper.
```{r read_trees}
...
This will generate a distorted image: correlations are not corrected for tree 
size. To correct for this, we will have to go over the entire correlation 
matrix.
