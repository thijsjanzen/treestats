...
```{r load_data}
begin <- "https://raw.githubusercontent.com/thijsjanzen/treestats-scripts/main/datasets/phylogenies/fracced/"
...
for (i in 1:length(tree_collection_files)) {
  #tree_collection <- readRDS(paste0(begin, tree_collection_files[i]))
...
cor1 <- cor1 %>%
  dplyr::mutate_at(1:ncol(cor1), as.numeric)
