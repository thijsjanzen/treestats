...
// laplacian_eigen_vals
std::vector<double> laplacian_eigen_vals(const Rcpp::List& phy);
RcppExport SEXP _treestats_laplacian_eigen_vals(SEXP phySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type phy(phySEXP);
    rcpp_result_gen = Rcpp::wrap(laplacian_eigen_vals(phy));
    return rcpp_result_gen;
END_RCPP
}
// calc_beta_cpp
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericMatrix& >::type ltable_R(ltable_RSEXP);
    rcpp_result_gen = Rcpp::wrap(avgLadder_ltable_cpp(ltable_R));
    return rcpp_result_gen;
END_RCPP
}
// calc_sackin_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_treestats_laplacian_eigen_vals", (DL_FUNC) &_treestats_laplacian_eigen_vals, 1},
